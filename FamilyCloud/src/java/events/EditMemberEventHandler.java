...
public class EditMemberEventHandler extends EventHandlerBase{
    ...
    protected String getURL() {
     ...
     public void process(HttpSession mySession, HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            User newUser3 = myUserDAO.getUserBasedOnIDforEdit(userID);
...
//            UserBO myUser = (UserBO) mySession.getAttribute("myUser");
             ...
             response.setContentType("text/html;charset=UTF-8");
             PrintWriter out = response.getWriter();
             //request.setAttribute("photoUserID", userID);
