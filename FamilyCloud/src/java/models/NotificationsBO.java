...
public class NotificationsBO {
    ...
    public NotificationsBO toNotificationsBO(Notifications note) {

        NotificationsBO noteBO = new NotificationsBO();

        noteBO.setNotificationID(note.getNotificationID());
        noteBO.setUserID_A(note.getUserID_A());
        noteBO.setUserID_B(note.getUserID_B());
        noteBO.setMessages(note.getMessages());
        noteBO.setNotification_type(note.getNotification_type());
        noteBO.setDate_created(note.getDate_created());
        noteBO.setIsreadA(note.getIsreadA());
        noteBO.setIsreadB(note.getIsreadB());
        noteBO.setReferredID(note.getReferredID());
