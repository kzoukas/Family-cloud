...
//to get states
function goToNotificationLocationPCreminder(notificationID)
{
    ...
    else
    {
        ...
        xmlHttp.onreadystatechange = notificationPCreminderChanged
...
function notificationPCreminderChanged()
{
